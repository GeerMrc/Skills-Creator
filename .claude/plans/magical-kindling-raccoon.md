...
|--------|----------|--------|----------|----------|----------|--------|
| T-001 | 删除旧的collect_requirements工具 | P0 | 10分钟 | pending | - | - |
| T-002 | 删除工作流相关模块（actions、elicit_workflow） | P0 | 15分钟 | pending | - | - |
| T-003 | 创建会话管理原子工具 | P0 | 2小时 | pending | - | - |
| T-004 | 创建问题获取原子工具 | P0 | 1.5小时 | pending | - | - |
| T-005 | 创建验证原子工具 | P0 | 1.5小时 | pending | - | - |
| T-006 | 简化validation模块 | P1 | 1小时 | pending | - | - |
| T-007 | 简化llm_services模块 | P1 | 1小时 | pending | - | - |
| T-008 | 简化session_manager模块 | P1 | 30分钟 | pending | - | - |
| T-009 | 编写新工具的单元测试 | P1 | 2小时 | pending | - | - |
| T-010 | 创建Agent-Skill工作流文档 | P1 | 1小时 | pending | - | - |
| T-011 | 更新SKILL.md添加工作流编排 | P1 | 30分钟 | pending | - | - |
| T-012 | 更新server.py注册新工具 | P0 | 15分钟 | pending | - | - |
| T-013 | 运行完整测试套件验证 | P0 | 15分钟 | pending | - | - |
| T-014 | 归档/取消重复计划 | P2 | 15分钟 | pending | - | - |
| T-015 | 更新技术债务清单 | P2 | 15分钟 | pending | - | - |
| T-016 | 更新ADR 001文档 | P2 | 30分钟 | pending | - | - |
...
**最近更新**:
- [2026-01-28] 计划创建并开始执行，基于全面审核审计报告
...
- [ ] **P0任务**（核心重构）
  - [ ] T-001: 删除旧的collect_requirements工具
  - [ ] T-002: 删除工作流相关模块
  - [ ] T-003: 创建会话管理原子工具
  - [ ] T-004: 创建问题获取原子工具
  - [ ] T-005: 创建验证原子工具
  - [ ] T-012: 更新server.py注册新工具
  - [ ] T-013: 运行完整测试套件验证

- [ ] **P1任务**（完善功能）
  - [ ] T-006: 简化validation模块
  - [ ] T-007: 简化llm_services模块
  - [ ] T-008: 简化session_manager模块
  - [ ] T-009: 编写新工具的单元测试
  - [ ] T-010: 创建Agent-Skill工作流文档
  - [ ] T-011: 更新SKILL.md添加工作流编排
