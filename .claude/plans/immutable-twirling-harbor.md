...
| T-008 | 更新文档和工具分类 | P1 | 20分钟 | in_progress | - | - |
| T-009 | 清理WIP提交（P3） | P3 | 10分钟 | pending | - | - |
| T-010 | 修复mypy缓存问题（P3） | P3 | 5分钟 | pending | - | - |
...
- [2026-01-28] T-007完成：迁移Phase 0工具到scripts/（23→18工具）
- [2026-01-28] T-008进行中：更新文档和工具分类
