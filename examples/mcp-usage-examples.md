...
本文档包含 skill-creator-mcp 工具和资源的详细使用示例。
...
```python
# 创建工作流型技能
init_skill(name="deployment-pipeline", template="workflow-based")
```
...
```python
# 创建分析型技能
init_skill(name="code-analyzer", template="analyzer-based")
```
...
```python
import os
from skill_creator_mcp import get_config
